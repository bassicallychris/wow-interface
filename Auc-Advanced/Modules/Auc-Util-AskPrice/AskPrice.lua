--[[
	...
	Version: 8.0.6138 (SwimmingSeadragon)
	Revision: $Id: AskPrice.lua 6138 2018-09-09 15:10:05Z none $
...
function private.GetVersion()
	return tonumber(("$Rev: 6138 $"):match("(%d+)")), (AucAdvanced.GetCurrentRevision()) --We just want the first return from GetCurrentRevision()
end
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-AskPrice/AskPrice.lua $", "$Rev: 6138 $")
