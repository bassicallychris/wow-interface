--[[
	...
	Version: 8.0.6161 (SwimmingSeadragon)
	Revision: $Id: Stubby.lua 6161 2018-09-09 15:10:05Z none $
...
LibStub("LibRevision"):Set("$URL: Stubby/Stubby.lua $","$Rev: 6161 $","5.1.DEV.", 'auctioneer', 'libs')
...
function getRevision()
	return tonumber(("$Rev: 6161 $"):match("(%d+)"))
end
