--[[
	...
	Version: 8.0.6156 (SwimmingSeadragon)
	Revision: $Id: PageOneReturn.lua 6156 2018-09-09 15:10:05Z none $
...
AucAdvanced.RegisterRevision("$URL: Auc-Util-FixAH/PageOneReturn.lua $", "$Rev: 6156 $")
