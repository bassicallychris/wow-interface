--[[
	...
	Version: 8.0.6162 (SwimmingSeadragon)
	Revision: $Id: Swatter.lua 6162 2018-09-09 15:10:05Z none $
...
LibStub("LibRevision"):Set("$URL: !Swatter/Swatter.lua $","$Rev: 6162 $","6.0.DEV.", 'auctioneer', 'libs')
